...
export 'user_roles_model.dart';

class UserRolesWidget extends StatefulWidget {
  const UserRolesWidget({super.key});

  static String routeName = 'UserRoles';
  static String routePath = '/userRoles';
...
class _UserRolesWidgetState extends State<UserRolesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserRolesModel());
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: SvgPicture.asset(
                              'assets/images/User_flow-rafiki_1.svg',
                              width: 103.0,
                              height: 103.0,
                              fit: BoxFit.cover,
                            ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: SvgPicture.asset(
                              'assets/images/Bus_driver-amico_1.svg',
                              width: 103.0,
                              height: 103.0,
                              fit: BoxFit.cover,
                            ),
