...
class SetUpAccountWidget extends StatefulWidget {
  const SetUpAccountWidget({super.key});

  static String routeName = 'SetUpAccount';
  static String routePath = '/setUpAccount';

  @override
  State<SetUpAccountWidget> createState() => _SetUpAccountWidgetState();
}
